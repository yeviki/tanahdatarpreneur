<script type="text/javascript">
    ...
    function formReset() {
        ...
        $('#id_bentuk_permodalan').select2().val('').trigger("change");
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data.status == 'RC200') {
                    ...
                    $('input[name="permodalanId"]').val(data.message.id_bentuk_permodalan);
                    $('input[name="fileshow"]').val(data.message.upload_foto_alat);
                    ...
                    $('#unit_usaha').val(data.message.unit_usaha);
                    $('#tahun_bantuan').val(data.message.tahun_bantuan);
                    $('#jumlah_uang_diterima').val(data.message.jumlah_uang_diterima);
                    $('#unit_pemberi_modal').val(data.message.unit_pemberi_modal);
                    $('#opd_pemberi_bantuan').val(data.message.opd_pemberi_bantuan);
                    $('#sub_kegiatan').val(data.message.sub_kegiatan);
                    $('#nm_alat').val(data.message.nm_alat);
                    $('#pemberi_permodalan').val(data.message.pemberi_permodalan);
                    ...
                    $('#id_bentuk_permodalan').select2().val(data.message.id_bentuk_permodalan).trigger("change");
                }
                $('#frmEntry').waitMe('hide');
            }
        });
    ...
    $( "#permodalan_uang" ).hide();
    $( "#permodalan_peralatan_1" ).hide();
    $( "#permodalan_peralatan_2" ).hide();
    
    
    $(document).on('change', '#id_bentuk_permodalan', function(e) {
      let id_pemodalan = $(this).val();
      console.log(id_pemodalan);
      if(id_pemodalan == '1') {
            $( "#permodalan_uang" ).show();
            $( "#permodalan_peralatan_1" ).hide();
            $( "#permodalan_peralatan_2" ).hide();
      } else if (id_pemodalan == '2') {
            $( "#permodalan_uang" ).hide();
            $( "#permodalan_peralatan_1" ).show();
            $( "#permodalan_peralatan_2" ).show();
      } else {
            $( "#permodalan_uang" ).hide();
            $( "#permodalan_peralatan_1" ).hide();
            $( "#permodalan_peralatan_2" ).hide();

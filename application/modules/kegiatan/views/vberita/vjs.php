<script type="text/javascript">
    ...
    function formReset() {
        ...
        $('#id_kat_urusan').select2().val('').trigger("change");
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data.status == 'RC200') {
                    ...
                    $('input[name="fileshow"]').val(data.message.file_foto);
                    $('#judul_berita').val(data.message.judul_berita);
                    $('#link_youtube').val(data.message.link_youtube);
    ...
    $(document).on('change input keyup', 'select[name="id_pelatihan"]', function(e) {
        let id = $(this).val();
        // getPertemuan(id);
        getDataDetail(id);
    });

    function getDataDetail(idPel) {
        $.ajax({
            type: 'POST',
            url: site + '/views',
            data: {

...
class Rekap_perizinan extends SLP_Controller
{
    protected $_vwName  = '';
    protected $_uriName = '';
    ...
    {
        parent::__construct();
        $this->load->model(array('model_rekap_perizinan' => 'mRekapLap', 'master/model_master' => 'mmas'));
        $this->_vwName = 'vRekapPerizinan';
        $this->_uriName = 'laporan/rekap-perizinan';
    }
    ...
    public function index()
    {
        ...
        $this->breadcrumb->add('Rekap Perizinan', site_url($this->_uriName));
        $this->session_info['page_name']    = 'Rekap Laporan Perizinan';
        ...
        <tr>
            ...
            <th width="20%"class="font-weight-bold">Total Perizinan</th>
        ';
        // foreach ($dataTahun as $d) {
        //     $tabelKepala .= '<th class="font-weight-bold">' . $d['tahun'] . '</th>';
        // }
        $tabelKepala .= '</tr>';

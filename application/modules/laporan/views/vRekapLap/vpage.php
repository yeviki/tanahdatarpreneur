            ...
            <div class="card card-cascade narrower z-depth-1">
                <div class="view view-cascade gradient-card-header blue-gradient-rgba narrower py-1 mx-4 mb-3 d-flex justify-content-between align-items-center">
                    <h5 class="white-text font-weight-normal mt-2">
                        ...
                        Rekap Data Total Peserta Pelatihan Per OPD
                    </h5>
                    <div class="clearfix">
...
<div class="modal fade" id="modalDetailPelatihan" tabindex="-1" role="dialog" aria-labelledby="modalRulesLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-xl" id="frmRules">
        <div class="modal-content">
            <div class="modal-header aqua-gradient-rgba">
                <h4 class="modal-title heading lead white-text font-weight-bold"> Detail Pelatihan </h4>
            ...
            <div class="modal-body">
                <div class="table-responsive-md">
                    ...
                    <table cellspacing="0" class="table table-striped table-borderless table-hover table-sm" id="tblviewpelatihan" width="100%">
                        <thead>
                            <tr>
                                <th class="font-weight-bold">#</th>
                                <th class="font-weight-bold">Nama Pelatihan</th>
                                <th class="font-weight-bold">Tempat Pelatihan</th>

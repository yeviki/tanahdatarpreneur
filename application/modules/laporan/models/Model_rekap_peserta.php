...
class Model_rekap_peserta extends CI_Model
{
    ...
    private function _get_datatables_query()
    {
        ...
        $this->db->select('a.id,
                           a.name,
                           (select count(b.id_peserta) from data_peserta b where b.id_regency = a.id) as total
                           ');
    ...
    public function printDataPeserta($id_regency)
    {

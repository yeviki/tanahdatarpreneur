                        ...
                        <table cellspacing="0" class="table table-striped table-borderless table-hover table-sm" id="tblList" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th width="10%" class="font-weight-bold">Label Kontrol</th>
                                    <th width="10%" class="font-weight-bold">Nama Kontrol</th>
                                    <th width="10%" class="font-weight-bold">URL Kontrol</th>
                                    <th width="55%" class="font-weight-bold">Deskripsi</th>

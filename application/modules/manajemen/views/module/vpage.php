                        ...
                        <table cellspacing="0" class="table table-striped table-borderless table-hover table-sm" id="tblList" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th width="10%" class="font-weight-bold">Label Module</th>
                                    <th width="10%" class="font-weight-bold">Nama Module</th>
                                    <th width="10%" class="font-weight-bold">URL Module</th>
                                    <th width="54%" class="font-weight-bold">Deskripsi</th>

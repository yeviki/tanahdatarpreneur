            ...
            <div class="card card-cascade narrower z-depth-1">
                <div class="view view-cascade gradient-card-header blue-gradient-rgba narrower py-1 mx-4 mb-3 d-flex justify-content-between align-items-center">
                    ...
                    <div class="clearfix">
                        ...
                        <button type="button" class="btn btn-success waves-effect waves-light px-3 py-2 font-weight-bold btnAdd" data-id=""><i class="fas fa-plus-circle"></i> Tambah Baru</button>
                    </div>
                </div>
                <div class="card-body mb-0">
                    <div class="table-responsive-md">
                        <table cellspacing="0" class="table table-striped table-borderless table-hover table-sm" id="tblList" width="100%">
                            <thead>
                                <tr>
                                    <th width="85%" class="font-weight-bold">Title Menu</th>
                                    <th width="3%" class="font-weight-bold text-center">Sort</th>
                                    <th width="6%" class="font-weight-bold text-center">Status</th>
                                    <th width="6%" class="font-weight-bold text-center">Action</th>
                                </tr>
                            </thead>
                            <tbody></tbody>
                        </table>

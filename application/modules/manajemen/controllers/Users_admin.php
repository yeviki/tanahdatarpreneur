...
class Users_admin extends SLP_Controller
{
    protected $_vwName   = '';
    protected $_uriName  = '';
    protected $_unitId   = '';
    ...
    {
        parent::__construct();
        $this->load->model(array('model_users_admin' => 'muser', 'master/model_master' => 'mmas'));
        $this->_vwName  = 'user_admin';
        $this->_uriName = 'manajemen/users-admin';
        //set data daerah
    ...
    public function index()
    {
        ...
        $this->breadcrumb->add('Users Admin', site_url($this->_uriName));

        $this->session_info['page_name']   = 'Manajamen User Admin';
